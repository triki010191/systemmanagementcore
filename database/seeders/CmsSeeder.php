...
class CmsSeeder extends Seeder
{
    ...
    private function seedModules(): void
    {
        $modules = [
            ...
            ['slug' => 'network-assets', 'name' => 'Aset Jaringan', 'is_core' => true, 'icon' => 'share', 'sort_order' => 6],
    ...
    private function seedNavigation(): void
    {
        ...
        $items = [
            ...
            ['label' => 'Join Closure', 'icon' => 'cable', 'route_name' => 'core-joints.index', 'permission' => 'cable.manage', 'module_slug' => 'cable-management', 'sort_order' => 5],
            ['label' => 'Manajemen Core', 'icon' => 'circle-stack', 'route_name' => 'cores.index', 'permission' => 'core.manage', 'module_slug' => 'core-management', 'sort_order' => 6],
            ['label' => 'Aset Jaringan', 'icon' => 'share', 'route_name' => null, 'url' => '/network/pops', 'permission' => 'network.view', 'module_slug' => 'network-assets', 'sort_order' => 7],
            ['label' => 'Pelanggan', 'icon' => 'users', 'route_name' => null, 'url' => '/network/customers', 'permission' => 'customer.view', 'module_slug' => 'customer-mapping', 'sort_order' => 8],
            ['label' => 'Koneksi Pelanggan', 'icon' => 'share', 'route_name' => null, 'url' => '/customer-connections', 'permission' => 'customer.view', 'module_slug' => 'customer-mapping', 'sort_order' => 9],
            ['label' => 'Import Bulk', 'icon' => 'cable', 'route_name' => null, 'url' => '/bulk-import', 'permission' => 'network.create', 'module_slug' => 'qr-tracking', 'sort_order' => 10],
            ['label' => 'Gangguan', 'icon' => 'exclamation-triangle', 'route_name' => 'trouble-tickets.index', 'permission' => 'fault.view', 'module_slug' => 'fault-management', 'sort_order' => 11],
            ['label' => 'Analisis Dampak', 'icon' => 'bolt', 'route_name' => 'impact-analysis.index', 'permission' => 'network.view', 'module_slug' => 'impact-analysis', 'sort_order' => 12],
            ['label' => 'OTDR Mapping', 'icon' => 'signal', 'route_name' => 'otdr-records.index', 'permission' => 'cable.manage', 'module_slug' => 'otdr-mapping', 'sort_order' => 13],
            ['label' => 'Maintenance', 'icon' => 'wrench', 'route_name' => 'maintenance-schedules.index', 'permission' => 'maintenance.view', 'module_slug' => 'maintenance', 'sort_order' => 14],
            ['label' => 'Audit Log', 'icon' => 'cog', 'route_name' => 'audit-logs.index', 'permission' => 'audit.view', 'module_slug' => 'cms', 'sort_order' => 15],
